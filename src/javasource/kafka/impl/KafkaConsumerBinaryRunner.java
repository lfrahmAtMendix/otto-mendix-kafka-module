...
public class KafkaConsumerBinaryRunner extends KafkaConsumerRunner implements Runnable {
	...
	public KafkaConsumerBinaryRunner(Consumer consumer, IContext context) throws CoreException {
			...
			try {
				...
				for (ConsumerRecord<String, byte[]> record : records) {
					...
					if (this.onReceiveInputParameters.containsKey("Value")) {
						microflowParams.put("Value", Base64.getEncoder().encodeToString(record.value()));
					}
